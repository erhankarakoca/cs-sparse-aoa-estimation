...
class RxView():
    ...
    def _beam_set(self):
        ...
        if beam_index != None:
            ...
            ra = rx_actions.RxActions(self.host)
            ra.beam(self.dev, beam_pol, beam_index)
    ...
    def _gain_set(self):
        ...
        if gain_index != None:
            ...
            ra = rx_actions.RxActions(self.host)
            ra.rf_gain(self.dev, gain_pol, gain_index)
    ...
    def setup_set(self):
        ...
        ra = rx_actions.RxActions(self.host)
        ra.setup(self.dev, mode, pol, latitude, ant_en_v, ant_en_h)
    ...
    def _calibrate(self):
        ...
        if pol == 'RV':
            ...
            pol = 'H'
        ra = rx_actions.RxActions(self.host)
        ra.dco_calibrate(self.dev, pol, gain_index)
