...
class Ram():
    ...
    __fields   = {'ram':      [32, [[15,15],[14,10],[9,5],[4,0]]],
                  ...
                  'rx_ram_v': [1,  [[79,70],[69,65],[64,61],[60,55],[54,49],[48,46],[45,42],[41,39],[38,37],[36,34],[33,32],[31,23],[22,16],[15,7],[6,0]]],
                  'rx_ram_h': [1,  [[79,70],[69,65],[64,61],[60,55],[54,49],[48,46],[45,42],[41,39],[38,37],[36,34],[33,32],[31,23],[22,16],[15,7],[6,0]]]
                 }
    ...
    @evk_logger.log_call
    def fill(self, devs, table_id=None, filename='ram.xml'):
        ...
        Args:
            ...
            table_id (str, optional): The ID of table to read from XML file. 
                                      ...
                                      Defaults to None.
            filename (str, optional): XML file name including path to be loaded. Defaults to 'ram.xml'.
        """
    ...
    def file_info(self, filename='ram.xml'):
        """Prints out information about the specified RAM XML file.
        The information included file header and table information.

        Args:
            filename (str, optional): The selected XML file name including path. Defaults to 'ram.xml'.
        """
        if not os.path.isabs(filename):
            filename = env_config.env_config.ram_path()+'/'+filename
        rf = ram_file.RamFile(filename)
    ...
    def get_ram_file(self, filename='ram.xml'):
        if not os.path.isabs(filename):
            filename = env_config.env_config.ram_path()+'/'+filename
