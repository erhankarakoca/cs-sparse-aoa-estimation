...
class TxDco():
    ...
    def _pre_calibration_settings(self, dev, pol, gain_index=0):
        ...
        self.current_tx_gain_index = self._chip.tx.load_gain_index_from_ram(dev, pol)[0]
    ...
    def calibrate(self, dev, mode, pol, cross_pol=True, fine_tune=True):
        ...
        #self._spi.wr(dev, 'bf_tx_biasref_trim', self.reg_backup[dev.get_name()]['bf_tx_biasref_trim'])
